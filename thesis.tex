...
\begin{itemize}
	...
	In other words, $\mu$ can be obtained as a thermodynamic limit with some fixed boundary condition.
\end{itemize}
\end{prop}
...
We now direct our attention to the source of the questions that inspired the theory which is presented in this thesis.
